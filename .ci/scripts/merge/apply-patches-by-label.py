...
def do_page(page):
    url = f"https://api.github.com/repos/xAstroDev/emuswitch/pulls?page={page}"
    ...
    if (response.ok):
        ...
        for pr in j:
            if (check_individual(pr["labels"])):
                ...
                print(subprocess.check_output(["git", "fetch", "https://github.com/xAstroDev/emuswitch.git", f"pull/{pn}/head:pr-{pn}", "-f", "--no-recurse-submodules"]))
